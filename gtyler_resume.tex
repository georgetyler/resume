...
Dissertation title: \textit{Social Media, Risk Perception, and Social Distancing: Evidence from 33 Million Geolocated Tweets} \\
...
First class (82/100). Honours economics courses: Econometrics 3, Development Economics, Mathematics for Economists (Real analysis, alongside 1st year PhD Economics course). Two CS courses: Introduction to Computer Science; Elements of Data Processing.
...
\section*{Experience}
\subsubsection*{Apr 2020 -- January 2021: Research Assistant, Durham University Business School}
...
\paragraph{\textit{Sept -- Jan}} RA for Dr. Kenju Kamei on an experimental economics project.
...
Web-scraping for economics; panel data cleaning and analysis. \\ Languages/Technologies: \texttt{Python, R, Git, Unix.}
