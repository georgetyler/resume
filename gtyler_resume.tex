...
\subsubsection*{2019--2020: Melbourne University (Study Abroad)}
  Courses included: Mathematics for Economists (Real Analysis using \textit{de la Fuente} textbook -- 86/100); Econometrics 3 (Postgraduate level -- 86/100); Development Economics; Data Processing with Python.
...
\begin{itemize}
	...
	\item Languages/Technologies: \tt Python, R, Stata, Git, Bash, Docker.
\end{itemize}
