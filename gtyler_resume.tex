...
Dissertation: \textit{Population Density and Shelter-in-Place Orders: A Bayesian Analysis} \\
Third year Economics modules: Advanced Macroeconomic Theory, Advanced Microeconomic Theory \\
First class overall in second year, \textbf{in the top 10 in cohort}. 
\subsubsection*{2019--2020: Melbourne University (Study Abroad)}
  Honours courses include: Mathematics for Economists (Real Analysis using de la Fuente, Mathematical Methods and Models textbook -- 86/100); Econometrics 3 (Postgraduate level -- 82/100); Development Economics; Data Processing with Python (2nd-year CS course, including web-scraping and machine learning).
...
I worked as a research assistant for Prof. Angel Hernando-Veciana on a paper about the public policy problems of COVID-19. I collected and cleaned medium-size datasets in R, including webscraping to generate panel data. I am now writing my dissertation using the dataset.
